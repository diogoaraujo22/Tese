...
However, there seems
to be no reported experience in using calculational proofs, e.g. the algebra
of programming. The main aim of this project is to challenge such algebraic methods
